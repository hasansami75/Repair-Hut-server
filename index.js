...
client.connect(err => {
    ...
    const serviceCollection = client.db("repairHut").collection("services");
    const reviewCollection = client.db("repairHut").collection("reviews");
    const orderCollection = client.db("repairHut").collection("orders");
    const adminEmailCollection = client.db("repairHut").collection("emails");
